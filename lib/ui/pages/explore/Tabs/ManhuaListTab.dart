...
class ManhuaListTab extends StatefulWidget {
  final String appBarTitle;

  ManhuaListTab({this.appBarTitle});

  @override
  _SubPageState createState() => _SubPageState();
}

class _SubPageState extends State<ManhuaListTab> {
  ScrollController _controller = ScrollController();
  bool _firstLoaded = false, _isLoading = false;
  int page = 1;
  List<ManhuaList> results = [];
  ...
  void onBottomReached() {
    setState(() {
      ...
      Future.delayed(Duration(seconds: 0), () async {
        results.addAll(
          widget.appBarTitle == 'Chapter Terbaru'
              ? await MangaData.getManhuaChapter(page: page)
              : await MangaData.getManhuaProject(page: page),
        );
        setState(() {
          _isLoading = false;
        });
  ...
  void getChapterTerbaru() async {
    results = await MangaData.getManhuaChapter(page: page);
    setState(() {
      _firstLoaded = true;
    });
  }
  ...
  void getProject() async {
    results = await MangaData.getManhuaProject(page: page);
    setState(() {
      _firstLoaded = true;
    });
  }
