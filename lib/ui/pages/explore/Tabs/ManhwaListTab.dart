...
class ManhwaListTab extends StatefulWidget {
  final String appBarTitle;

  ManhwaListTab({this.appBarTitle});

  @override
  _SubPageState createState() => _SubPageState();
}

class _SubPageState extends State<ManhwaListTab> {
  ScrollController _controller = ScrollController();
  bool _firstLoaded = false, _isLoading = false;
  int page = 1;
  List<ManhwaList> results = [];
  ...
  void onBottomReached() {
    setState(() {
      ...
      Future.delayed(Duration(seconds: 0), () async {
        results.addAll(
          widget.appBarTitle == 'Chapter Terbaru'
              ? await MangaData.getManhwaChapter(page: page)
              : await MangaData.getManhwaProject(page: page),
        );
        setState(() {
          _isLoading = false;
        });
  ...
  void getChapterTerbaru() async {
    results = await MangaData.getManhwaChapter(page: page);
    setState(() {
      _firstLoaded = true;
    });
  }
  ...
  void getProject() async {
    results = await MangaData.getManhwaProject(page: page);
    setState(() {
      _firstLoaded = true;
    });
  }
