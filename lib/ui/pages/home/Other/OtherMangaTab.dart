...
class OtherMangaTab extends StatefulWidget {
  @override
  _BrowseTabState createState() => _BrowseTabState();
}

class _BrowseTabState extends State<OtherMangaTab>
  ...
  void getData() async {
    ...
    popularList = resData['popularMangaLocal'];
    bestSeriesList = resData['bestSeriesLocal'];
    homeList = resData['homeMangaLocal'];
    latestChapterList = resData['latestChapterMangaLocal'];
    allList = resData['allMangaLocal'];
    setState(() {
      _isLoaded = true;
    });
  }
